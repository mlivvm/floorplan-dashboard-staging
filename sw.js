...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.26',
  'app.css?v=1.9.26',
  'env-config.js?v=1.9.26',
  'data-service.js?v=1.9.26',
  'diagnostics-service.js?v=1.9.26',
  'floorplan-cache-service.js?v=1.9.26',
  'floorplan-view-service.js?v=1.9.26',
  'auth-service.js?v=1.9.26',
  'status-service.js?v=1.9.26',
  'status-sync-service.js?v=1.9.26',
  'mode-service.js?v=1.9.26',
  'image-editor-service.js?v=1.9.26',
  'viewport-service.js?v=1.9.26',
  'marker-service.js?v=1.9.26',
  'door-action-service.js?v=1.9.26',
  'ui-shell-service.js?v=1.9.26',
  'export-service.js?v=1.9.26',
  'edit-ui-service.js?v=1.9.26',
  'pdf-import-service.js?v=1.9.26',
  'upload-service.js?v=1.9.26',
  'select-sheet-service.js?v=1.9.26',
  'side-panel-service.js?v=1.9.26',
  'app.js?v=1.9.26',
  'version.json',
  'manifest.json',
  'icon-192.png',
