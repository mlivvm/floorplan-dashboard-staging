...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.16',
  'app.css?v=1.9.16',
  'env-config.js?v=1.9.16',
  'data-service.js?v=1.9.16',
  'diagnostics-service.js?v=1.9.16',
  'floorplan-cache-service.js?v=1.9.16',
  'floorplan-view-service.js?v=1.9.16',
  'auth-service.js?v=1.9.16',
  'status-service.js?v=1.9.16',
  'status-sync-service.js?v=1.9.16',
  'mode-service.js?v=1.9.16',
  'image-editor-service.js?v=1.9.16',
  'viewport-service.js?v=1.9.16',
  'marker-service.js?v=1.9.16',
  'door-action-service.js?v=1.9.16',
  'ui-shell-service.js?v=1.9.16',
  'edit-ui-service.js?v=1.9.16',
  'pdf-import-service.js?v=1.9.16',
  'upload-service.js?v=1.9.16',
  'select-sheet-service.js?v=1.9.16',
  'side-panel-service.js?v=1.9.16',
  'app.js?v=1.9.16',
  'version.json',
  'manifest.json',
  'icon-192.png',
