...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.12',
  'app.css?v=1.9.12',
  'env-config.js?v=1.9.12',
  'data-service.js?v=1.9.12',
  'diagnostics-service.js?v=1.9.12',
  'floorplan-cache-service.js?v=1.9.12',
  'floorplan-view-service.js?v=1.9.12',
  'auth-service.js?v=1.9.12',
  'status-service.js?v=1.9.12',
  'status-sync-service.js?v=1.9.12',
  'mode-service.js?v=1.9.12',
  'image-editor-service.js?v=1.9.12',
  'viewport-service.js?v=1.9.12',
  'marker-service.js?v=1.9.12',
  'door-action-service.js?v=1.9.12',
  'ui-shell-service.js?v=1.9.12',
  'edit-ui-service.js?v=1.9.12',
  'pdf-import-service.js?v=1.9.12',
  'upload-service.js?v=1.9.12',
  'select-sheet-service.js?v=1.9.12',
  'side-panel-service.js?v=1.9.12',
  'app.js?v=1.9.12',
  'version.json',
  'manifest.json',
  'icon-192.png',
