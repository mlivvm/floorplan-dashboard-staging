...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.15',
  'app.css?v=1.9.15',
  'env-config.js?v=1.9.15',
  'data-service.js?v=1.9.15',
  'diagnostics-service.js?v=1.9.15',
  'floorplan-cache-service.js?v=1.9.15',
  'floorplan-view-service.js?v=1.9.15',
  'auth-service.js?v=1.9.15',
  'status-service.js?v=1.9.15',
  'status-sync-service.js?v=1.9.15',
  'mode-service.js?v=1.9.15',
  'image-editor-service.js?v=1.9.15',
  'viewport-service.js?v=1.9.15',
  'marker-service.js?v=1.9.15',
  'door-action-service.js?v=1.9.15',
  'ui-shell-service.js?v=1.9.15',
  'edit-ui-service.js?v=1.9.15',
  'pdf-import-service.js?v=1.9.15',
  'upload-service.js?v=1.9.15',
  'select-sheet-service.js?v=1.9.15',
  'side-panel-service.js?v=1.9.15',
  'app.js?v=1.9.15',
  'version.json',
  'manifest.json',
  'icon-192.png',
