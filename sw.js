...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.30',
  'app.css?v=1.9.30',
  'env-config.js?v=1.9.30',
  'data-service.js?v=1.9.30',
  'diagnostics-service.js?v=1.9.30',
  'floorplan-cache-service.js?v=1.9.30',
  'floorplan-view-service.js?v=1.9.30',
  'auth-service.js?v=1.9.30',
  'status-service.js?v=1.9.30',
  'status-sync-service.js?v=1.9.30',
  'mode-service.js?v=1.9.30',
  'image-editor-service.js?v=1.9.30',
  'viewport-service.js?v=1.9.30',
  'marker-service.js?v=1.9.30',
  'door-action-service.js?v=1.9.30',
  'ui-shell-service.js?v=1.9.30',
  'export-service.js?v=1.9.30',
  'edit-ui-service.js?v=1.9.30',
  'pdf-import-service.js?v=1.9.30',
  'upload-service.js?v=1.9.30',
  'select-sheet-service.js?v=1.9.30',
  'side-panel-service.js?v=1.9.30',
  'app.js?v=1.9.30',
  'version.json',
  'manifest.json',
  'icon-192.png',
