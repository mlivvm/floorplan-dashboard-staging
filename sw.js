...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.31',
  'app.css?v=1.9.31',
  'env-config.js?v=1.9.31',
  'data-service.js?v=1.9.31',
  'diagnostics-service.js?v=1.9.31',
  'floorplan-cache-service.js?v=1.9.31',
  'floorplan-view-service.js?v=1.9.31',
  'auth-service.js?v=1.9.31',
  'status-service.js?v=1.9.31',
  'status-sync-service.js?v=1.9.31',
  'mode-service.js?v=1.9.31',
  'image-editor-service.js?v=1.9.31',
  'viewport-service.js?v=1.9.31',
  'marker-service.js?v=1.9.31',
  'door-action-service.js?v=1.9.31',
  'ui-shell-service.js?v=1.9.31',
  'export-service.js?v=1.9.31',
  'edit-ui-service.js?v=1.9.31',
  'pdf-import-service.js?v=1.9.31',
  'upload-service.js?v=1.9.31',
  'select-sheet-service.js?v=1.9.31',
  'side-panel-service.js?v=1.9.31',
  'app.js?v=1.9.31',
  'version.json',
  'manifest.json',
  'icon-192.png',
