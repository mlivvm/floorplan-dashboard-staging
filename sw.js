...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.25',
  'app.css?v=1.9.25',
  'env-config.js?v=1.9.25',
  'data-service.js?v=1.9.25',
  'diagnostics-service.js?v=1.9.25',
  'floorplan-cache-service.js?v=1.9.25',
  'floorplan-view-service.js?v=1.9.25',
  'auth-service.js?v=1.9.25',
  'status-service.js?v=1.9.25',
  'status-sync-service.js?v=1.9.25',
  'mode-service.js?v=1.9.25',
  'image-editor-service.js?v=1.9.25',
  'viewport-service.js?v=1.9.25',
  'marker-service.js?v=1.9.25',
  'door-action-service.js?v=1.9.25',
  'ui-shell-service.js?v=1.9.25',
  'export-service.js?v=1.9.25',
  'edit-ui-service.js?v=1.9.25',
  'pdf-import-service.js?v=1.9.25',
  'upload-service.js?v=1.9.25',
  'select-sheet-service.js?v=1.9.25',
  'side-panel-service.js?v=1.9.25',
  'app.js?v=1.9.25',
  'version.json',
  'manifest.json',
  'icon-192.png',
