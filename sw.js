...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.2',
  'app.css?v=1.9.2',
  'env-config.js?v=1.9.2',
  'data-service.js?v=1.9.2',
  'diagnostics-service.js?v=1.9.2',
  'floorplan-cache-service.js?v=1.9.2',
  'floorplan-view-service.js?v=1.9.2',
  'auth-service.js?v=1.9.2',
  'status-service.js?v=1.9.2',
  'status-sync-service.js?v=1.9.2',
  'mode-service.js?v=1.9.2',
  'image-editor-service.js?v=1.9.2',
  'viewport-service.js?v=1.9.2',
  'marker-service.js?v=1.9.2',
  'door-action-service.js?v=1.9.2',
  'ui-shell-service.js?v=1.9.2',
  'edit-ui-service.js?v=1.9.2',
  'pdf-import-service.js?v=1.9.2',
  'upload-service.js?v=1.9.2',
  'select-sheet-service.js?v=1.9.2',
  'side-panel-service.js?v=1.9.2',
  'app.js?v=1.9.2',
  'version.json',
  'manifest.json',
  'icon-192.png',
