...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.9',
  'app.css?v=1.9.9',
  'env-config.js?v=1.9.9',
  'data-service.js?v=1.9.9',
  'diagnostics-service.js?v=1.9.9',
  'floorplan-cache-service.js?v=1.9.9',
  'floorplan-view-service.js?v=1.9.9',
  'auth-service.js?v=1.9.9',
  'status-service.js?v=1.9.9',
  'status-sync-service.js?v=1.9.9',
  'mode-service.js?v=1.9.9',
  'image-editor-service.js?v=1.9.9',
  'viewport-service.js?v=1.9.9',
  'marker-service.js?v=1.9.9',
  'door-action-service.js?v=1.9.9',
  'ui-shell-service.js?v=1.9.9',
  'edit-ui-service.js?v=1.9.9',
  'pdf-import-service.js?v=1.9.9',
  'upload-service.js?v=1.9.9',
  'select-sheet-service.js?v=1.9.9',
  'side-panel-service.js?v=1.9.9',
  'app.js?v=1.9.9',
  'version.json',
  'manifest.json',
  'icon-192.png',
