...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.13',
  'app.css?v=1.9.13',
  'env-config.js?v=1.9.13',
  'data-service.js?v=1.9.13',
  'diagnostics-service.js?v=1.9.13',
  'floorplan-cache-service.js?v=1.9.13',
  'floorplan-view-service.js?v=1.9.13',
  'auth-service.js?v=1.9.13',
  'status-service.js?v=1.9.13',
  'status-sync-service.js?v=1.9.13',
  'mode-service.js?v=1.9.13',
  'image-editor-service.js?v=1.9.13',
  'viewport-service.js?v=1.9.13',
  'marker-service.js?v=1.9.13',
  'door-action-service.js?v=1.9.13',
  'ui-shell-service.js?v=1.9.13',
  'edit-ui-service.js?v=1.9.13',
  'pdf-import-service.js?v=1.9.13',
  'upload-service.js?v=1.9.13',
  'select-sheet-service.js?v=1.9.13',
  'side-panel-service.js?v=1.9.13',
  'app.js?v=1.9.13',
  'version.json',
  'manifest.json',
  'icon-192.png',
