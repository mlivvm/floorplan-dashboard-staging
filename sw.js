...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.32',
  'app.css?v=1.9.32',
  'env-config.js?v=1.9.32',
  'data-service.js?v=1.9.32',
  'diagnostics-service.js?v=1.9.32',
  'floorplan-cache-service.js?v=1.9.32',
  'floorplan-view-service.js?v=1.9.32',
  'auth-service.js?v=1.9.32',
  'status-service.js?v=1.9.32',
  'status-sync-service.js?v=1.9.32',
  'mode-service.js?v=1.9.32',
  'image-editor-service.js?v=1.9.32',
  'viewport-service.js?v=1.9.32',
  'marker-service.js?v=1.9.32',
  'door-action-service.js?v=1.9.32',
  'ui-shell-service.js?v=1.9.32',
  'export-service.js?v=1.9.32',
  'edit-ui-service.js?v=1.9.32',
  'pdf-import-service.js?v=1.9.32',
  'upload-service.js?v=1.9.32',
  'select-sheet-service.js?v=1.9.32',
  'side-panel-service.js?v=1.9.32',
  'app.js?v=1.9.32',
  'version.json',
  'manifest.json',
  'icon-192.png',
