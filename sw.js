...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.8.171',
  'app.css?v=1.8.171',
  'env-config.js?v=1.8.171',
  'data-service.js?v=1.8.171',
  'diagnostics-service.js?v=1.8.171',
  'floorplan-cache-service.js?v=1.8.171',
  'floorplan-view-service.js?v=1.8.171',
  'auth-service.js?v=1.8.171',
  'status-service.js?v=1.8.171',
  'status-sync-service.js?v=1.8.171',
  'mode-service.js?v=1.8.171',
  'image-editor-service.js?v=1.8.171',
  'viewport-service.js?v=1.8.171',
  'marker-service.js?v=1.8.171',
  'door-action-service.js?v=1.8.171',
  'ui-shell-service.js?v=1.8.171',
  'edit-ui-service.js?v=1.8.171',
  'pdf-import-service.js?v=1.8.171',
  'upload-service.js?v=1.8.171',
  'select-sheet-service.js?v=1.8.171',
  'side-panel-service.js?v=1.8.171',
  'app.js?v=1.8.171',
  'version.json',
  'manifest.json',
  'icon-192.png',
