...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.3',
  'app.css?v=1.9.3',
  'env-config.js?v=1.9.3',
  'data-service.js?v=1.9.3',
  'diagnostics-service.js?v=1.9.3',
  'floorplan-cache-service.js?v=1.9.3',
  'floorplan-view-service.js?v=1.9.3',
  'auth-service.js?v=1.9.3',
  'status-service.js?v=1.9.3',
  'status-sync-service.js?v=1.9.3',
  'mode-service.js?v=1.9.3',
  'image-editor-service.js?v=1.9.3',
  'viewport-service.js?v=1.9.3',
  'marker-service.js?v=1.9.3',
  'door-action-service.js?v=1.9.3',
  'ui-shell-service.js?v=1.9.3',
  'edit-ui-service.js?v=1.9.3',
  'pdf-import-service.js?v=1.9.3',
  'upload-service.js?v=1.9.3',
  'select-sheet-service.js?v=1.9.3',
  'side-panel-service.js?v=1.9.3',
  'app.js?v=1.9.3',
  'version.json',
  'manifest.json',
  'icon-192.png',
