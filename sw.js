...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.22',
  'app.css?v=1.9.22',
  'env-config.js?v=1.9.22',
  'data-service.js?v=1.9.22',
  'diagnostics-service.js?v=1.9.22',
  'floorplan-cache-service.js?v=1.9.22',
  'floorplan-view-service.js?v=1.9.22',
  'auth-service.js?v=1.9.22',
  'status-service.js?v=1.9.22',
  'status-sync-service.js?v=1.9.22',
  'mode-service.js?v=1.9.22',
  'image-editor-service.js?v=1.9.22',
  'viewport-service.js?v=1.9.22',
  'marker-service.js?v=1.9.22',
  'door-action-service.js?v=1.9.22',
  'ui-shell-service.js?v=1.9.22',
  'export-service.js?v=1.9.22',
  'edit-ui-service.js?v=1.9.22',
  'pdf-import-service.js?v=1.9.22',
  'upload-service.js?v=1.9.22',
  'select-sheet-service.js?v=1.9.22',
  'side-panel-service.js?v=1.9.22',
  'app.js?v=1.9.22',
  'version.json',
  'manifest.json',
  'icon-192.png',
