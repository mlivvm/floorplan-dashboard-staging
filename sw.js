...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.8.168',
  'app.css?v=1.8.168',
  'env-config.js?v=1.8.168',
  'data-service.js?v=1.8.168',
  'diagnostics-service.js?v=1.8.168',
  'floorplan-cache-service.js?v=1.8.168',
  'floorplan-view-service.js?v=1.8.168',
  'auth-service.js?v=1.8.168',
  'status-service.js?v=1.8.168',
  'status-sync-service.js?v=1.8.168',
  'mode-service.js?v=1.8.168',
  'image-editor-service.js?v=1.8.168',
  'viewport-service.js?v=1.8.168',
  'marker-service.js?v=1.8.168',
  'door-action-service.js?v=1.8.168',
  'ui-shell-service.js?v=1.8.168',
  'edit-ui-service.js?v=1.8.168',
  'pdf-import-service.js?v=1.8.168',
  'upload-service.js?v=1.8.168',
  'select-sheet-service.js?v=1.8.168',
  'side-panel-service.js?v=1.8.168',
  'app.js?v=1.8.168',
  'version.json',
  'manifest.json',
  'icon-192.png',
