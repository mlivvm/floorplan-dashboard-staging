...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.5',
  'app.css?v=1.9.5',
  'env-config.js?v=1.9.5',
  'data-service.js?v=1.9.5',
  'diagnostics-service.js?v=1.9.5',
  'floorplan-cache-service.js?v=1.9.5',
  'floorplan-view-service.js?v=1.9.5',
  'auth-service.js?v=1.9.5',
  'status-service.js?v=1.9.5',
  'status-sync-service.js?v=1.9.5',
  'mode-service.js?v=1.9.5',
  'image-editor-service.js?v=1.9.5',
  'viewport-service.js?v=1.9.5',
  'marker-service.js?v=1.9.5',
  'door-action-service.js?v=1.9.5',
  'ui-shell-service.js?v=1.9.5',
  'edit-ui-service.js?v=1.9.5',
  'pdf-import-service.js?v=1.9.5',
  'upload-service.js?v=1.9.5',
  'select-sheet-service.js?v=1.9.5',
  'side-panel-service.js?v=1.9.5',
  'app.js?v=1.9.5',
  'version.json',
  'manifest.json',
  'icon-192.png',
