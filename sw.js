...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.11',
  'app.css?v=1.9.11',
  'env-config.js?v=1.9.11',
  'data-service.js?v=1.9.11',
  'diagnostics-service.js?v=1.9.11',
  'floorplan-cache-service.js?v=1.9.11',
  'floorplan-view-service.js?v=1.9.11',
  'auth-service.js?v=1.9.11',
  'status-service.js?v=1.9.11',
  'status-sync-service.js?v=1.9.11',
  'mode-service.js?v=1.9.11',
  'image-editor-service.js?v=1.9.11',
  'viewport-service.js?v=1.9.11',
  'marker-service.js?v=1.9.11',
  'door-action-service.js?v=1.9.11',
  'ui-shell-service.js?v=1.9.11',
  'edit-ui-service.js?v=1.9.11',
  'pdf-import-service.js?v=1.9.11',
  'upload-service.js?v=1.9.11',
  'select-sheet-service.js?v=1.9.11',
  'side-panel-service.js?v=1.9.11',
  'app.js?v=1.9.11',
  'version.json',
  'manifest.json',
  'icon-192.png',
