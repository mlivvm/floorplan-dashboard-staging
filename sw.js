...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.34',
  'app.css?v=1.9.34',
  'env-config.js?v=1.9.34',
  'data-service.js?v=1.9.34',
  'diagnostics-service.js?v=1.9.34',
  'floorplan-cache-service.js?v=1.9.34',
  'floorplan-view-service.js?v=1.9.34',
  'auth-service.js?v=1.9.34',
  'status-service.js?v=1.9.34',
  'status-sync-service.js?v=1.9.34',
  'mode-service.js?v=1.9.34',
  'image-editor-service.js?v=1.9.34',
  'viewport-service.js?v=1.9.34',
  'marker-service.js?v=1.9.34',
  'door-action-service.js?v=1.9.34',
  'ui-shell-service.js?v=1.9.34',
  'export-service.js?v=1.9.34',
  'edit-ui-service.js?v=1.9.34',
  'pdf-import-service.js?v=1.9.34',
  'upload-service.js?v=1.9.34',
  'select-sheet-service.js?v=1.9.34',
  'side-panel-service.js?v=1.9.34',
  'app.js?v=1.9.34',
  'version.json',
  'manifest.json',
  'icon-192.png',
