...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.39',
  'app.css?v=1.9.39',
  'env-config.js?v=1.9.39',
  'data-service.js?v=1.9.39',
  'diagnostics-service.js?v=1.9.39',
  'floorplan-cache-service.js?v=1.9.39',
  'floorplan-view-service.js?v=1.9.39',
  'auth-service.js?v=1.9.39',
  'status-service.js?v=1.9.39',
  'status-sync-service.js?v=1.9.39',
  'mode-service.js?v=1.9.39',
  'image-editor-service.js?v=1.9.39',
  'viewport-service.js?v=1.9.39',
  'marker-service.js?v=1.9.39',
  'door-action-service.js?v=1.9.39',
  'ui-shell-service.js?v=1.9.39',
  'export-service.js?v=1.9.39',
  'edit-ui-service.js?v=1.9.39',
  'pdf-import-service.js?v=1.9.39',
  'upload-service.js?v=1.9.39',
  'select-sheet-service.js?v=1.9.39',
  'side-panel-service.js?v=1.9.39',
  'app.js?v=1.9.39',
  'version.json',
  'manifest.json',
  'icon-192.png',
