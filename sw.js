...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.24',
  'app.css?v=1.9.24',
  'env-config.js?v=1.9.24',
  'data-service.js?v=1.9.24',
  'diagnostics-service.js?v=1.9.24',
  'floorplan-cache-service.js?v=1.9.24',
  'floorplan-view-service.js?v=1.9.24',
  'auth-service.js?v=1.9.24',
  'status-service.js?v=1.9.24',
  'status-sync-service.js?v=1.9.24',
  'mode-service.js?v=1.9.24',
  'image-editor-service.js?v=1.9.24',
  'viewport-service.js?v=1.9.24',
  'marker-service.js?v=1.9.24',
  'door-action-service.js?v=1.9.24',
  'ui-shell-service.js?v=1.9.24',
  'export-service.js?v=1.9.24',
  'edit-ui-service.js?v=1.9.24',
  'pdf-import-service.js?v=1.9.24',
  'upload-service.js?v=1.9.24',
  'select-sheet-service.js?v=1.9.24',
  'side-panel-service.js?v=1.9.24',
  'app.js?v=1.9.24',
  'version.json',
  'manifest.json',
  'icon-192.png',
