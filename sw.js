...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.27',
  'app.css?v=1.9.27',
  'env-config.js?v=1.9.27',
  'data-service.js?v=1.9.27',
  'diagnostics-service.js?v=1.9.27',
  'floorplan-cache-service.js?v=1.9.27',
  'floorplan-view-service.js?v=1.9.27',
  'auth-service.js?v=1.9.27',
  'status-service.js?v=1.9.27',
  'status-sync-service.js?v=1.9.27',
  'mode-service.js?v=1.9.27',
  'image-editor-service.js?v=1.9.27',
  'viewport-service.js?v=1.9.27',
  'marker-service.js?v=1.9.27',
  'door-action-service.js?v=1.9.27',
  'ui-shell-service.js?v=1.9.27',
  'export-service.js?v=1.9.27',
  'edit-ui-service.js?v=1.9.27',
  'pdf-import-service.js?v=1.9.27',
  'upload-service.js?v=1.9.27',
  'select-sheet-service.js?v=1.9.27',
  'side-panel-service.js?v=1.9.27',
  'app.js?v=1.9.27',
  'version.json',
  'manifest.json',
  'icon-192.png',
