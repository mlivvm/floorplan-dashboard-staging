...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.6',
  'app.css?v=1.9.6',
  'env-config.js?v=1.9.6',
  'data-service.js?v=1.9.6',
  'diagnostics-service.js?v=1.9.6',
  'floorplan-cache-service.js?v=1.9.6',
  'floorplan-view-service.js?v=1.9.6',
  'auth-service.js?v=1.9.6',
  'status-service.js?v=1.9.6',
  'status-sync-service.js?v=1.9.6',
  'mode-service.js?v=1.9.6',
  'image-editor-service.js?v=1.9.6',
  'viewport-service.js?v=1.9.6',
  'marker-service.js?v=1.9.6',
  'door-action-service.js?v=1.9.6',
  'ui-shell-service.js?v=1.9.6',
  'edit-ui-service.js?v=1.9.6',
  'pdf-import-service.js?v=1.9.6',
  'upload-service.js?v=1.9.6',
  'select-sheet-service.js?v=1.9.6',
  'side-panel-service.js?v=1.9.6',
  'app.js?v=1.9.6',
  'version.json',
  'manifest.json',
  'icon-192.png',
