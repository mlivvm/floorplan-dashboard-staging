...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.21',
  'app.css?v=1.9.21',
  'env-config.js?v=1.9.21',
  'data-service.js?v=1.9.21',
  'diagnostics-service.js?v=1.9.21',
  'floorplan-cache-service.js?v=1.9.21',
  'floorplan-view-service.js?v=1.9.21',
  'auth-service.js?v=1.9.21',
  'status-service.js?v=1.9.21',
  'status-sync-service.js?v=1.9.21',
  'mode-service.js?v=1.9.21',
  'image-editor-service.js?v=1.9.21',
  'viewport-service.js?v=1.9.21',
  'marker-service.js?v=1.9.21',
  'door-action-service.js?v=1.9.21',
  'ui-shell-service.js?v=1.9.21',
  'export-service.js?v=1.9.21',
  'edit-ui-service.js?v=1.9.21',
  'pdf-import-service.js?v=1.9.21',
  'upload-service.js?v=1.9.21',
  'select-sheet-service.js?v=1.9.21',
  'side-panel-service.js?v=1.9.21',
  'app.js?v=1.9.21',
  'version.json',
  'manifest.json',
  'icon-192.png',
