...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.35',
  'app.css?v=1.9.35',
  'env-config.js?v=1.9.35',
  'data-service.js?v=1.9.35',
  'diagnostics-service.js?v=1.9.35',
  'floorplan-cache-service.js?v=1.9.35',
  'floorplan-view-service.js?v=1.9.35',
  'auth-service.js?v=1.9.35',
  'status-service.js?v=1.9.35',
  'status-sync-service.js?v=1.9.35',
  'mode-service.js?v=1.9.35',
  'image-editor-service.js?v=1.9.35',
  'viewport-service.js?v=1.9.35',
  'marker-service.js?v=1.9.35',
  'door-action-service.js?v=1.9.35',
  'ui-shell-service.js?v=1.9.35',
  'export-service.js?v=1.9.35',
  'edit-ui-service.js?v=1.9.35',
  'pdf-import-service.js?v=1.9.35',
  'upload-service.js?v=1.9.35',
  'select-sheet-service.js?v=1.9.35',
  'side-panel-service.js?v=1.9.35',
  'app.js?v=1.9.35',
  'version.json',
  'manifest.json',
  'icon-192.png',
