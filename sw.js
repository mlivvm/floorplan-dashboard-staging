...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.1',
  'app.css?v=1.9.1',
  'env-config.js?v=1.9.1',
  'data-service.js?v=1.9.1',
  'diagnostics-service.js?v=1.9.1',
  'floorplan-cache-service.js?v=1.9.1',
  'floorplan-view-service.js?v=1.9.1',
  'auth-service.js?v=1.9.1',
  'status-service.js?v=1.9.1',
  'status-sync-service.js?v=1.9.1',
  'mode-service.js?v=1.9.1',
  'image-editor-service.js?v=1.9.1',
  'viewport-service.js?v=1.9.1',
  'marker-service.js?v=1.9.1',
  'door-action-service.js?v=1.9.1',
  'ui-shell-service.js?v=1.9.1',
  'edit-ui-service.js?v=1.9.1',
  'pdf-import-service.js?v=1.9.1',
  'upload-service.js?v=1.9.1',
  'select-sheet-service.js?v=1.9.1',
  'side-panel-service.js?v=1.9.1',
  'app.js?v=1.9.1',
  'version.json',
  'manifest.json',
  'icon-192.png',
