...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.29',
  'app.css?v=1.9.29',
  'env-config.js?v=1.9.29',
  'data-service.js?v=1.9.29',
  'diagnostics-service.js?v=1.9.29',
  'floorplan-cache-service.js?v=1.9.29',
  'floorplan-view-service.js?v=1.9.29',
  'auth-service.js?v=1.9.29',
  'status-service.js?v=1.9.29',
  'status-sync-service.js?v=1.9.29',
  'mode-service.js?v=1.9.29',
  'image-editor-service.js?v=1.9.29',
  'viewport-service.js?v=1.9.29',
  'marker-service.js?v=1.9.29',
  'door-action-service.js?v=1.9.29',
  'ui-shell-service.js?v=1.9.29',
  'export-service.js?v=1.9.29',
  'edit-ui-service.js?v=1.9.29',
  'pdf-import-service.js?v=1.9.29',
  'upload-service.js?v=1.9.29',
  'select-sheet-service.js?v=1.9.29',
  'side-panel-service.js?v=1.9.29',
  'app.js?v=1.9.29',
  'version.json',
  'manifest.json',
  'icon-192.png',
