...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.36',
  'app.css?v=1.9.36',
  'env-config.js?v=1.9.36',
  'data-service.js?v=1.9.36',
  'diagnostics-service.js?v=1.9.36',
  'floorplan-cache-service.js?v=1.9.36',
  'floorplan-view-service.js?v=1.9.36',
  'auth-service.js?v=1.9.36',
  'status-service.js?v=1.9.36',
  'status-sync-service.js?v=1.9.36',
  'mode-service.js?v=1.9.36',
  'image-editor-service.js?v=1.9.36',
  'viewport-service.js?v=1.9.36',
  'marker-service.js?v=1.9.36',
  'door-action-service.js?v=1.9.36',
  'ui-shell-service.js?v=1.9.36',
  'export-service.js?v=1.9.36',
  'edit-ui-service.js?v=1.9.36',
  'pdf-import-service.js?v=1.9.36',
  'upload-service.js?v=1.9.36',
  'select-sheet-service.js?v=1.9.36',
  'side-panel-service.js?v=1.9.36',
  'app.js?v=1.9.36',
  'version.json',
  'manifest.json',
  'icon-192.png',
