...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.14',
  'app.css?v=1.9.14',
  'env-config.js?v=1.9.14',
  'data-service.js?v=1.9.14',
  'diagnostics-service.js?v=1.9.14',
  'floorplan-cache-service.js?v=1.9.14',
  'floorplan-view-service.js?v=1.9.14',
  'auth-service.js?v=1.9.14',
  'status-service.js?v=1.9.14',
  'status-sync-service.js?v=1.9.14',
  'mode-service.js?v=1.9.14',
  'image-editor-service.js?v=1.9.14',
  'viewport-service.js?v=1.9.14',
  'marker-service.js?v=1.9.14',
  'door-action-service.js?v=1.9.14',
  'ui-shell-service.js?v=1.9.14',
  'edit-ui-service.js?v=1.9.14',
  'pdf-import-service.js?v=1.9.14',
  'upload-service.js?v=1.9.14',
  'select-sheet-service.js?v=1.9.14',
  'side-panel-service.js?v=1.9.14',
  'app.js?v=1.9.14',
  'version.json',
  'manifest.json',
  'icon-192.png',
