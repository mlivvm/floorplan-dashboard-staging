...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.19',
  'app.css?v=1.9.19',
  'env-config.js?v=1.9.19',
  'data-service.js?v=1.9.19',
  'diagnostics-service.js?v=1.9.19',
  'floorplan-cache-service.js?v=1.9.19',
  'floorplan-view-service.js?v=1.9.19',
  'auth-service.js?v=1.9.19',
  'status-service.js?v=1.9.19',
  'status-sync-service.js?v=1.9.19',
  'mode-service.js?v=1.9.19',
  'image-editor-service.js?v=1.9.19',
  'viewport-service.js?v=1.9.19',
  'marker-service.js?v=1.9.19',
  'door-action-service.js?v=1.9.19',
  'ui-shell-service.js?v=1.9.19',
  'export-service.js?v=1.9.19',
  'edit-ui-service.js?v=1.9.19',
  'pdf-import-service.js?v=1.9.19',
  'upload-service.js?v=1.9.19',
  'select-sheet-service.js?v=1.9.19',
  'side-panel-service.js?v=1.9.19',
  'app.js?v=1.9.19',
  'version.json',
  'manifest.json',
  'icon-192.png',
