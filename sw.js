...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.33',
  'app.css?v=1.9.33',
  'env-config.js?v=1.9.33',
  'data-service.js?v=1.9.33',
  'diagnostics-service.js?v=1.9.33',
  'floorplan-cache-service.js?v=1.9.33',
  'floorplan-view-service.js?v=1.9.33',
  'auth-service.js?v=1.9.33',
  'status-service.js?v=1.9.33',
  'status-sync-service.js?v=1.9.33',
  'mode-service.js?v=1.9.33',
  'image-editor-service.js?v=1.9.33',
  'viewport-service.js?v=1.9.33',
  'marker-service.js?v=1.9.33',
  'door-action-service.js?v=1.9.33',
  'ui-shell-service.js?v=1.9.33',
  'export-service.js?v=1.9.33',
  'edit-ui-service.js?v=1.9.33',
  'pdf-import-service.js?v=1.9.33',
  'upload-service.js?v=1.9.33',
  'select-sheet-service.js?v=1.9.33',
  'side-panel-service.js?v=1.9.33',
  'app.js?v=1.9.33',
  'version.json',
  'manifest.json',
  'icon-192.png',
