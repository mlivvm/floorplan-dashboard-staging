...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.28',
  'app.css?v=1.9.28',
  'env-config.js?v=1.9.28',
  'data-service.js?v=1.9.28',
  'diagnostics-service.js?v=1.9.28',
  'floorplan-cache-service.js?v=1.9.28',
  'floorplan-view-service.js?v=1.9.28',
  'auth-service.js?v=1.9.28',
  'status-service.js?v=1.9.28',
  'status-sync-service.js?v=1.9.28',
  'mode-service.js?v=1.9.28',
  'image-editor-service.js?v=1.9.28',
  'viewport-service.js?v=1.9.28',
  'marker-service.js?v=1.9.28',
  'door-action-service.js?v=1.9.28',
  'ui-shell-service.js?v=1.9.28',
  'export-service.js?v=1.9.28',
  'edit-ui-service.js?v=1.9.28',
  'pdf-import-service.js?v=1.9.28',
  'upload-service.js?v=1.9.28',
  'select-sheet-service.js?v=1.9.28',
  'side-panel-service.js?v=1.9.28',
  'app.js?v=1.9.28',
  'version.json',
  'manifest.json',
  'icon-192.png',
