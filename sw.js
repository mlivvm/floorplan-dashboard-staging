...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.8',
  'app.css?v=1.9.8',
  'env-config.js?v=1.9.8',
  'data-service.js?v=1.9.8',
  'diagnostics-service.js?v=1.9.8',
  'floorplan-cache-service.js?v=1.9.8',
  'floorplan-view-service.js?v=1.9.8',
  'auth-service.js?v=1.9.8',
  'status-service.js?v=1.9.8',
  'status-sync-service.js?v=1.9.8',
  'mode-service.js?v=1.9.8',
  'image-editor-service.js?v=1.9.8',
  'viewport-service.js?v=1.9.8',
  'marker-service.js?v=1.9.8',
  'door-action-service.js?v=1.9.8',
  'ui-shell-service.js?v=1.9.8',
  'edit-ui-service.js?v=1.9.8',
  'pdf-import-service.js?v=1.9.8',
  'upload-service.js?v=1.9.8',
  'select-sheet-service.js?v=1.9.8',
  'side-panel-service.js?v=1.9.8',
  'app.js?v=1.9.8',
  'version.json',
  'manifest.json',
  'icon-192.png',
