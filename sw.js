...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.4',
  'app.css?v=1.9.4',
  'env-config.js?v=1.9.4',
  'data-service.js?v=1.9.4',
  'diagnostics-service.js?v=1.9.4',
  'floorplan-cache-service.js?v=1.9.4',
  'floorplan-view-service.js?v=1.9.4',
  'auth-service.js?v=1.9.4',
  'status-service.js?v=1.9.4',
  'status-sync-service.js?v=1.9.4',
  'mode-service.js?v=1.9.4',
  'image-editor-service.js?v=1.9.4',
  'viewport-service.js?v=1.9.4',
  'marker-service.js?v=1.9.4',
  'door-action-service.js?v=1.9.4',
  'ui-shell-service.js?v=1.9.4',
  'edit-ui-service.js?v=1.9.4',
  'pdf-import-service.js?v=1.9.4',
  'upload-service.js?v=1.9.4',
  'select-sheet-service.js?v=1.9.4',
  'side-panel-service.js?v=1.9.4',
  'app.js?v=1.9.4',
  'version.json',
  'manifest.json',
  'icon-192.png',
