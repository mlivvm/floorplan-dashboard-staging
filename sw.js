...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.10',
  'app.css?v=1.9.10',
  'env-config.js?v=1.9.10',
  'data-service.js?v=1.9.10',
  'diagnostics-service.js?v=1.9.10',
  'floorplan-cache-service.js?v=1.9.10',
  'floorplan-view-service.js?v=1.9.10',
  'auth-service.js?v=1.9.10',
  'status-service.js?v=1.9.10',
  'status-sync-service.js?v=1.9.10',
  'mode-service.js?v=1.9.10',
  'image-editor-service.js?v=1.9.10',
  'viewport-service.js?v=1.9.10',
  'marker-service.js?v=1.9.10',
  'door-action-service.js?v=1.9.10',
  'ui-shell-service.js?v=1.9.10',
  'edit-ui-service.js?v=1.9.10',
  'pdf-import-service.js?v=1.9.10',
  'upload-service.js?v=1.9.10',
  'select-sheet-service.js?v=1.9.10',
  'side-panel-service.js?v=1.9.10',
  'app.js?v=1.9.10',
  'version.json',
  'manifest.json',
  'icon-192.png',
